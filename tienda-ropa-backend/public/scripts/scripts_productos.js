...
async function cargarProductos(productos) {
    try {
        ...
        productos.forEach(producto => {
            ...
            card.innerHTML = `
      <div class="card position-relative h-100" onclick="window.location.href='detalleProductos.html?idGrupo=${producto.id}'" style="cursor: pointer;">
...
async function cargarProductosNewIn() {
  try {
    ...
    nuevos.forEach(producto => {
      ...
      card.className = 'col-md-3 mb-4';
      card.innerHTML = `
      <div class="card position-relative h-100" onclick="window.location.href='detalleProductos.html?idGrupo=${producto.producto_padre_id}'" style="cursor: pointer;">
